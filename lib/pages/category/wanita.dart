...
class WanitaPage extends StatefulWidget {
  const WanitaPage({super.key});

  @override
  State<WanitaPage> createState() => _WanitaPageState();
}

class _WanitaPageState extends State<WanitaPage> {
  List<ProductModel> _products = [];
  bool _isLoading = true;

  final String wanitaCategoryId =
      'afb318f5-93f4-46cf-93df-5e3ab067803b'; // Ganti dengan ID kategori WANITA kamu di Supabase
